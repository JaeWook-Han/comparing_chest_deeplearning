...
def main():
    ...
    paths_labels = {
        '': 0, # please input your train dataset path
        '': 1, # please input your test dataset path
    }
...
def get_arguments():
    ...
    parser.add_argument('--dataset_name', type=str, default="chest_xray", choices=('chest_xray'))
    parser.add_argument('--batch_size', type=int, default=64)
    parser.add_argument('--num_workers', type=int, default=0)
    parser.add_argument('--machine', type=str, default="Cluster", choices=('Cluster', 'Mac'))
    parser.add_argument('--model_name', type=str, default="VGG16", choices=('VGG16', 'ResNet', 'DenseNet'))
